...
(function (global) {
  ...
  var DICT = {
    en: {
      ...
      "lp.faqA4": "PIX (instant), credit card and boleto, securely processed by Asaas. We never see or store your card details.",
      ...
      "lp.footTransparency": "Prices in Brazilian Reais (BRL), taxes included. Subscriptions renew automatically until cancelled. Payments processed by Asaas.",
      ...
      "pay.cpf": "CPF / CNPJ",
      "pay.cpfHint": "Required by Asaas to issue your invoice (LGPD-protected).",
      "pay.loginToContinue": "Log in to continue",
      "pay.createAccount": "Create my account",
      "pay.payNow": "Pay securely",
      "pay.securedBy": "Encrypted & processed by Asaas",
    ...
    "pt-BR": {
      ...
      "lp.faqA4": "PIX (instantâneo), cartão de crédito e boleto, processados com segurança pelo Asaas. Nunca vemos nem armazenamos os dados do seu cartão.",
      ...
      "lp.footTransparency": "Preços em Reais (BRL), impostos incluídos. As assinaturas renovam automaticamente até o cancelamento. Pagamentos processados pelo Asaas.",
      ...
      "pay.cpf": "CPF / CNPJ",
      "pay.cpfHint": "Exigido pelo Asaas para emitir sua cobrança (protegido pela LGPD).",
      "pay.loginToContinue": "Entrar para continuar",
      "pay.createAccount": "Criar minha conta",
      "pay.payNow": "Pagar com segurança",
      "pay.securedBy": "Criptografado e processado pelo Asaas",
