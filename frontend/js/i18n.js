...
(function (global) {
  ...
  var DICT = {
    en: {
      ...
      "lp.nm2Title": "The impatient driver",
      "lp.nm2Body": "The meter is running, the accent is thick, and ‘sorry?’ only works twice before the eyes roll.",
      "lp.nm3Title": "The frozen interview",
      "lp.nm3Body": "The job is yours to lose. Your mind goes blank. The silence stretches for a year.",
      "lp.nm4Title": "The 3am emergency",
      "lp.nm4Body": "A hospital. A form. A word you've never heard — and everything depends on getting it right.",
    ...
    "pt-BR": {
      ...
      "lp.nm2Title": "O motorista impaciente",
      "lp.nm2Body": "O taxímetro corre, o sotaque é carregado, e ‘sorry?’ só funciona duas vezes antes do revirar de olhos.",
      "lp.nm3Title": "A entrevista travada",
      "lp.nm3Body": "A vaga é sua para perder. Sua mente apaga. O silêncio se estende por um ano.",
      "lp.nm4Title": "A emergência das 3h",
      "lp.nm4Body": "Um hospital. Um formulário. Uma palavra que você nunca ouviu — e tudo depende de acertar.",
