...
export const CONTENT_MODULES = []
  .concat(BLOCK0_MODULES, BLOCK02_MODULES, BLOCK03_MODULES, BLOCK04_MODULES, BLOCK05_MODULES);

export const CONTENT_BY_SEQUENCE = Object.assign(
  {}, BLOCK0_BY_SEQUENCE, BLOCK02_BY_SEQUENCE, BLOCK03_BY_SEQUENCE, BLOCK04_BY_SEQUENCE, BLOCK05_BY_SEQUENCE
);
